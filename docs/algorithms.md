...
- Code owners: `src/epcsaft/native/equilibrium_nlp/ipopt_adapter.cpp:254` (class IpoptTnlpAdapter final : public Ipopt::TNLP {)
...
- Validation: tests/regression/literature/test_literature_binary_kij_regression.py
...
- Code owners: `src/epcsaft/bindings.cpp:3077` (m.def("_fit_generic_native_ceres", &fit_generic_native_ceres_binding);), `src/epcsaft/native/epcsaft_regression.cpp:565` (ceres::Solver::Options ceres_regression_options_cpp(int max_num_iterations) {)
...
- Validation: tests/equilibrium/core/test_tp_flash.py
...
- Code owners: `src/epcsaft/bindings.cpp:1858` (m.def("_native_neutral_tp_flash_eos_nlp_contract", [](), `src/epcsaft/bindings.cpp:2475` (m.def("_native_neutral_tp_flash_eos_route_result", [](), `src/epcsaft/equilibrium.py:293` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/equilibrium_nlp/route_builders.cpp:1120` (NeutralTwoPhaseEosNlpContract evaluate_neutral_two_phase_eos_tp_flash_nlp_contract(), `src/epcsaft/native/equilibrium_nlp/route_builders.cpp:1879` (NeutralTwoPhaseEosRouteResult solve_neutral_two_phase_eos_tp_flash_route()
...
- Implementation owner: src/epcsaft/equilibrium.py; src/epcsaft/native/equilibrium_nlp/route_builders.cpp; src/epcsaft/bindings.cpp
- Validation: tests/equilibrium/core/test_lle.py
...
- Code owners: `src/epcsaft/bindings.cpp:1877` (m.def("_native_neutral_lle_eos_nlp_contract", [](), `src/epcsaft/bindings.cpp:2508` (m.def("_native_neutral_lle_eos_route_result", [](), `src/epcsaft/equilibrium.py:406` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/equilibrium_nlp/route_builders.cpp:1143` (NeutralTwoPhaseEosNlpContract evaluate_neutral_two_phase_eos_lle_nlp_contract(), `src/epcsaft/native/equilibrium_nlp/route_builders.cpp:1909` (NeutralTwoPhaseEosRouteResult solve_neutral_two_phase_eos_lle_route()
...
- Implementation owner: src/epcsaft/equilibrium.py; src/epcsaft/native/equilibrium_nlp/route_builders.cpp; src/epcsaft/bindings.cpp
- Validation: tests/equilibrium/electrolyte/test_electrolyte_lle_smokes.py
...
- Code owners: `src/epcsaft/bindings.cpp:1896` (m.def("_native_electrolyte_lle_eos_nlp_contract", [](), `src/epcsaft/bindings.cpp:2541` (m.def("_native_electrolyte_lle_eos_route_result", [](), `src/epcsaft/equilibrium.py:429` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/equilibrium_nlp/route_builders.cpp:1166` (NeutralTwoPhaseEosNlpContract evaluate_electrolyte_lle_eos_nlp_contract(), `src/epcsaft/native/equilibrium_nlp/route_builders.cpp:1939` (NeutralTwoPhaseEosRouteResult solve_electrolyte_lle_eos_route()
...
- Validation: tests/equilibrium/core/test_bubble_dew.py
...
- Code owners: `src/epcsaft/bindings.cpp:2107` (m.def("_native_neutral_bubble_p_eos_nlp_contract", [](), `src/epcsaft/bindings.cpp:2579` (m.def("_native_neutral_bubble_p_eos_route_result", [](), `src/epcsaft/equilibrium.py:354` (@dataclass(frozen=True, slots=True)), `src/epcsaft/equilibrium.py:380` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/equilibrium_nlp/bubble_dew_route_builders.cpp:964` (NeutralTwoPhaseEosRouteResult solve_pressure_route(), `src/epcsaft/native/equilibrium_nlp/bubble_dew_route_builders.cpp:1037` (NeutralTwoPhaseEosRouteResult solve_temperature_route()
...
- Validation: tests/equilibrium/core/test_stability.py
...
- Code owners: `src/epcsaft/bindings.cpp:2188` (m.def("_native_neutral_stability_tpd_nlp_contract", [](), `src/epcsaft/bindings.cpp:2731` (m.def("_native_neutral_stability_tpd_route_result", [](), `src/epcsaft/equilibrium.py:311` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/equilibrium_nlp/stability_route_builders.cpp:560` (StabilityRouteResult solve_neutral_stability_tpd_route(), `src/epcsaft/native/equilibrium_nlp/stability_route_builders.cpp:589` (StabilityRouteResult solve_electrolyte_stability_tpd_route()
...
- Code owners: `src/epcsaft/bindings.cpp:3083` (m.def("_solve_chemical_equilibrium_native", &solve_chemical_equilibrium_native_binding);), `src/epcsaft/equilibrium.py:485` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/equilibrium_nlp/ideal_speciation_problem.cpp:607` (IdealSpeciationIpoptResult solve_ideal_speciation_ipopt(), `src/epcsaft/native/equilibrium_nlp/ideal_speciation_problem.cpp:640` (ChemicalEquilibriumResultNative solve_ideal_speciation_chemical_equilibrium_ipopt(), `src/epcsaft/reactive_speciation.py:468` (def _solve_reactive_speciation_native()
...
- Code owners: `src/epcsaft/bindings.cpp:3083` (m.def("_solve_chemical_equilibrium_native", &solve_chemical_equilibrium_native_binding);), `src/epcsaft/equilibrium.py:485` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/epcsaft_chemical_equilibrium.cpp:1340` (ChemicalEquilibriumResultNative solve_nonideal_speciation_chemical_equilibrium_ipopt(), `src/epcsaft/reactive_speciation.py:468` (def _solve_reactive_speciation_native()
...
- Code owners: `src/epcsaft/bindings.cpp:1951` (m.def("_native_reactive_lle_eos_nlp_contract", [](), `src/epcsaft/equilibrium.py:537` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/equilibrium/reactive_phase_equilibrium_problem.cpp:1814` (epcsaft::native::equilibrium_nlp::ReactiveTwoPhaseEosRouteResult solve_reactive_phase_liquid_root_route_native(), `src/epcsaft/native/equilibrium_nlp/route_builders.cpp:1496` (ReactiveTwoPhaseEosRouteResult solve_reactive_lle_eos_route()
...
- Code owners: `src/epcsaft/bindings.cpp:1988` (m.def("_native_reactive_electrolyte_lle_eos_nlp_contract", [](), `src/epcsaft/equilibrium.py:537` (@dataclass(frozen=True, slots=True)), `src/epcsaft/native/equilibrium/reactive_phase_equilibrium_problem.cpp:1814` (epcsaft::native::equilibrium_nlp::ReactiveTwoPhaseEosRouteResult solve_reactive_phase_liquid_root_route_native(), `src/epcsaft/native/equilibrium_nlp/route_builders.cpp:1537` (ReactiveTwoPhaseEosRouteResult solve_reactive_electrolyte_lle_eos_route()
...
- Code owners: `src/epcsaft/bindings.cpp:3072` (m.def("_fit_pure_neutral_native_ceres", &fit_pure_neutral_native_ceres_binding);), `src/epcsaft/native/epcsaft_regression.cpp:578` (class PureNeutralCeresCostFunction final : public ceres::CostFunction {), `src/epcsaft/regression.py:2336` (def fit_pure_neutral(), `src/epcsaft/regression.py:2673` (def fit_pure_parameters()
...
- Code owners: `src/epcsaft/bindings.cpp:3077` (m.def("_fit_generic_native_ceres", &fit_generic_native_ceres_binding);), `src/epcsaft/native/epcsaft_regression.cpp:1537` (class PureIonCeresCostFunction final : public ceres::CostFunction {), `src/epcsaft/regression.py:2721` (def fit_pure_ion(), `src/epcsaft/regression.py:2924` (def fit_liquid_electrolyte_parameters()
...
- Code owners: `src/epcsaft/bindings.cpp:3077` (m.def("_fit_generic_native_ceres", &fit_generic_native_ceres_binding);), `src/epcsaft/native/epcsaft_regression.cpp:1660` (class BinaryKijCeresCostFunction final : public ceres::CostFunction {), `src/epcsaft/regression.py:2750` (def fit_binary_parameters()
...
- Code owners: `src/epcsaft/reactive_regression.py:749` (def build_reactive_regression_objective(), `src/epcsaft/reactive_regression.py:780` (def evaluate_reactive_regression_objective(), `src/epcsaft/runtime.py:682` ("reactive_electrolyte_batch_context": {)
