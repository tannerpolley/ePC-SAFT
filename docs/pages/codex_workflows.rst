...
.. list-table::
   ...
   * - Plot asset rebuild
     ...
     - Opt-in generated plot producers and static asset report.
...
- Plot asset changes: use ``uv run python scripts/codex_check.py plots`` only when regenerating local plot outputs is explicitly part of the task.
