...
# Per-agent copy for generic-vle-fugacity-equilibrium. Defaults are filled for this worktree branch.

param(
    [string]$Branch = "codex/generic-vle-fugacity-equilibrium",
    [string[]]$IssueNumbers = @("86"),
    [string[]]$PrNumbers = @(),
