...
Completion requires a verified native surface that can support the electrolyte LLE residual Jacobian without placeholder, stale, identity-only, or manual numeric perturbation derivatives.
