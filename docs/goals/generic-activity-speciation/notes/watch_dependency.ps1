...
# Per-agent copy for generic-activity-speciation. Defaults are filled for this worktree branch.

param(
    [string]$Branch = "codex/generic-activity-speciation",
    [string[]]$IssueNumbers = @("86", "87"),
    [string[]]$PrNumbers = @(),
