...
def _typed_problem_fixture() -> tuple[ePCSAFTMixture, np.ndarray, dict[str, object]]:
    ...
    return mix, feed, {"aq": aq, "org": org, "phase_fraction": beta_org}


def test_electrolyte_lle_problem_requires_native_ipopt_route() -> None:
    mix, feed, initial_phases = _typed_problem_fixture()
