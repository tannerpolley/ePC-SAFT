            ...
            "reactive_electrolyte_batch_context": {
                ...
                "native_ceres_thermodynamic_regression": {
                    ...
                    "supported_slice": {
                        ...
                        "parameter_kind_constraints": {
                            "reaction_equilibrium_constant": "ideal, concentration, and supported activity-standard-state reactive_speciation rows",
                            "log_equilibrium_constant": "ideal, concentration, and supported activity-standard-state reactive_speciation rows",
                            "born_radius": "supported activity-standard-state reactive_speciation rows on the nonassociating ionic Born/SSM+DS slice",
                    ...
                    "blocked_parameter_kinds": {
                        "k_ij": "generic EOS binary interaction sensitivities are not yet wired through the native reactive_speciation thermo regression path",
