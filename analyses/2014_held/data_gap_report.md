...
- Figure 2: model curves for NaCl/KCl at 273.15 K and 298.15 K with digitized panel data for KCl (273.15 K, 298.15 K) and NaCl (273.15 K), plus exact NaCl 298.15 K data (`figure_2/plot_figure_2.py`, `data/reference/osmotic/water/2014_Held_figure_2_digitized.csv` mirrored to `figure_2/figure_2_digitized.csv`).
