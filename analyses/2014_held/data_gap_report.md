...
- Figure 1 now stages `NaCl.csv` and `KBr.csv` into `figures/figure_1/input/`.
- Figure 2 now stages `held_2014_figure_2_digitized.csv` and `NaCl.csv` into `figures/figure_2/input/`.
- Figure 3 now stages `LiAc-NaAc-KAc.csv` into `figures/figure_3/input/`.
