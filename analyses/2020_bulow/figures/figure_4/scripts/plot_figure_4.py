...
DATASETS = [
    ("a", "Water to methanol", "methanol", common.analysis_data_path(__file__, "water-methanol-comparison.csv", kind="input")),
    ("b", "Water to ethanol", "ethanol", common.analysis_data_path(__file__, "water-ethanol-comparison.csv", kind="input")),
]
SERIES = [
