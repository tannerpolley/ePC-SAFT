...
from analyses.package_plot_smokes.tests.plots.plot_helpers import Backend_unavailable_gradient_values
...
def test_regression_gradient_Backend_unavailable_parity_plot() -> None:
    actual, expected = Backend_unavailable_gradient_values()
    save_parity_plot(
        "regression_gradient_Backend_unavailable_parity.png",
        "Native regression gradient vs Backend unavailable",
        ["m", "sigma", "epsilon"],
        actual,
        expected,
