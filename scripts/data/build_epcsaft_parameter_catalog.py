...
OUT_DIR = REPO_ROOT / "data" / "reference" / "epcsaft_parameters" / "catalog"
...
def _build_catalog() -> Dict[str, Any]:
    ...
    ion_rows = {
        "Li+": {
            "2005": (1.8059, 1110.9261),
            "2008": (1.8177, 2697.2795),
            "2014_s1": (1.8177, 2697.2795),
            "2014_s2": (2.8449, 360.0),
            "2020": (2.8449, 360.0),
            "2025": (2.8449, 360.0),
            "z": 1.0,
            "MW": 6.941e-3,
        ...
        "Na+": {
            "2005": (1.6262, 119.8060),
            "2008": (2.4122, 646.0504),
            "2014_s1": (2.4122, 646.0504),
            "2014_s2": (2.8232, 230.0),
            "2020": (2.8232, 230.0),
            "2025": (2.8232, 230.0),
            "z": 1.0,
            "MW": 22.98e-3,
        ...
        "K+": {
            "2005": (2.7602, 8.8773),
            "2008": (2.9698, 271.0518),
            "2014_s1": (2.9698, 271.0518),
            "2014_s2": (3.3417, 200.0),
            "2020": (3.3417, 200.0),
            "2025": (3.3417, 200.0),
            "z": 1.0,
            "MW": 39.0983e-3,
        ...
        "Cl-": {
            "2005": (3.5991, 359.6604),
            "2008": (3.0575, 47.2878),
            "2014_s1": (3.0575, 47.2878),
            "2014_s2": (2.7560, 170.0),
            "2020": (2.7560, 170.0),
            "2025": (2.7560, 170.0),
            "z": -1.0,
            "MW": 35.453e-3,
        ...
        "Br-": {
            "2005": (3.8225, 524.0636),
            "2008": (3.4573, 60.2216),
            "2014_s1": (3.4573, 60.2216),
            "2014_s2": (3.0707, 190.0),
            "2020": (3.0707, 190.0),
            "2025": (3.0707, 190.0),
            "z": -1.0,
            "MW": 79.904e-3,
        ...
        "I-": {
            "2005": (4.1766, 413.0494),
            "2008": (3.9319, 80.4347),
            "2014_s1": (3.9319, 80.4347),
            "2014_s2": (3.6672, 200.0),
            "2020": (3.6672, 200.0),
            "2025": (3.6672, 200.0),
            "z": -1.0,
            "MW": 126.90447e-3,
    ...
    for ion, row in ion_rows.items():
        component_parameters[ion] = {
            "MW": {"default": row["MW"]},
            "m": {"default": 1.0},
            "s": {k: row[k][0] for k in ("2005", "2008", "2014_s1", "2014_s2", "2020", "2025")}
            | {"default": row["2020"][0]},
            "e": {k: row[k][1] for k in ("2005", "2008", "2014_s1", "2014_s2", "2020", "2025")}
            | {"default": row["2020"][1]},
            "e_assoc": {"default": 0.0},
            "vol_a": {"default": 0.0},
    ...
    def _normalize_preset_model(model):
        ...
        return {
            ...
            "born_model": {
                ...
                "mu_born_model": {
                    "differential_mode": (
                        "numerical" if bool(born_term_options.get("numerical", False)) else "analytical"
                    ),
    ...
    presets = {
        "legacy_default": {
            ...
            "model": {
                ...
                "born_term_options": {"numerical": False, "sum_term": True, "deps_dx_term": True, "d_born_mode": 2},
                "eps_r_bulk": "mix",
