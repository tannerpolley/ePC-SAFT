    ...
    (
        ...
        (
            ...
            BenchmarkCase(
                ...
                validation_paths=(
                    "tests/workflows/data_validation/test_mea_co2_pressure_speciation.py",
                    "analyses/data_validation/mea_co2_pressure_speciation/results/pressure_speciation/summary.json",
                ),
                notes="Package-owned MEA data-validation lane is source-backed but blocked until SSM/DS Born composition sensitivity is implemented for phase-state residuals.",
                blocked_by_issue=119,
            ),
        ),
    )
