        ...
        (
            ...
            BenchmarkCase(
                ...
                package_surface=(
                    ...
                    "docs/plans/issue_116_revised_native_electrolyte_lle_solver.md",
                ),
                validation_paths=(),
                notes="Issue #116 closed the core distributed-ion solver lane, but issue #119 does not yet wire an Ascani-style executable benchmark through its owned release-gate surfaces.",
                blocked_by_issue=119,
            ),
        ),
        (
            ...
            BenchmarkCase(
                ...
                input_records=("docs/plans/issue_117_revised_native_coupled_reactive_lle_solver.md",),
                expected=None,
                tolerances=None,
                command="uv run python scripts/benchmarks/benchmark_literature_suite.py --case ascani_2023_reactive_phase_equilibrium",
                status=BLOCKED,
                package_surface=("docs/plans/issue_117_revised_native_coupled_reactive_lle_solver.md",),
                validation_paths=(),
                notes="Issue #117 closed the upstream solver lane, but the issue #119 package-side release-gate command and fixture wiring for Ascani 2023 is still absent.",
                blocked_by_issue=119,
            ),
        ),
        (
