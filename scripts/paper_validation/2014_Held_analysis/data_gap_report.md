...
- Figure 2: model curves for NaCl/KCl at 273.15 K and 298.15 K with digitized panel data for KCl (273.15 K, 298.15 K) and NaCl (273.15 K), plus exact NaCl 298.15 K data (`figure_2/plot_figure_2.py`, `data/osmotic/water/2014_Held_figure_2_digitized.csv` mirrored to `figure_2/figure_2_digitized.csv`).
- Figure 3: LiAc/NaAc/KAc osmotic coefficients with strategy-2 model and a classical ePC-SAFT reference using the new `2009_Held` dataset (`figure_3/plot_figure_3.py`) and the richer acetate data file `data/osmotic/water/LiAc-NaAc-KAc.csv` mirrored to `figure_3/LiAc-NaAc-KAc.csv`.
