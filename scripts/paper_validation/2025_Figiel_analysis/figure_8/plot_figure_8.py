...
def _plot_panel(ax, label, salt, m_max, y_max, include_legend: bool = False):
    ...
    m_grid_meoh, y_meoh = common.mean_ionic_activity_curve('figiel_2025', salt, 'methanol', {'methanol': 1.0}, meoh_curve_max, points=600)
    m_grid_etoh, y_etoh = common.mean_ionic_activity_curve('figiel_2025', salt, 'ethanol', {'ethanol': 1.0}, etoh_curve_max, points=600)
