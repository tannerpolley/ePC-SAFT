...
- `hc`: rows for pcsaft, feos, Clapeyron.jl.
- `disp`: rows for pcsaft, feos, Clapeyron.jl.
- `assoc`: rows for pcsaft, feos, Clapeyron.jl.
- `dh`: rows for pcsaft, feos, Clapeyron.jl.
- `born`: rows for pcsaft, feos, Clapeyron.jl.
