...
function config_files(clapeyron_root::String)
    adv_like = joinpath(clapeyron_root, "database", "SAFT", "PCSAFT", "ePCSAFTAdv", "ePCSAFTAdv_like.csv")
    adv_unlike = joinpath(clapeyron_root, "database", "SAFT", "PCSAFT", "ePCSAFTAdv", "ePCSAFTAdv_unlike.csv")
    rev_like = joinpath(clapeyron_root, "database", "SAFT", "PCSAFT", "ePCSAFT", "ePCSAFT_like.csv")
    rev_unlike = joinpath(clapeyron_root, "database", "SAFT", "PCSAFT", "ePCSAFT", "ePCSAFT_unlike.csv")
    return Dict(
