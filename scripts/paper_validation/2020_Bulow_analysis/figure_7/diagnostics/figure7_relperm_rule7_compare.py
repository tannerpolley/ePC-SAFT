...
def _curve(dataset: str, salt: str, solvent: str, x_vals: np.ndarray, user_options: dict | None = None) -> np.ndarray:
    ...
    params = get_prop_dict(dataset, fig7._species_for_combo(salt, solvent), x_ref, fig7.T_REF, user_options=user_options or {})
...
def main() -> None:
    ...
    for panel in fig7.PANELS:
        ...
        ax.scatter(x_eval, y_eval, s=26, facecolor='white', edgecolor='black', linewidth=0.8, label='Paper points', zorder=5)
